...
files <- list.files("output_data", pattern = "es_mod_clust_", full.names = T)
...
ggsave(plot = es_plot_clement,
       filename = here("figures", "grid_level_event_study_multiple_gt_din_clust.pdf"),
       width = 9,
       height = 6,
       units = "cm")
