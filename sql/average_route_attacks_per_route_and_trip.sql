WITH
  ...
  SELECT
    ...
    SUM(number_previous_attacks_grid_12_months_all_encounter_types) number_previous_attacks_grid_12_months_all_encounter_types
  FROM 
  ...
  SELECT
    ...
    AVG(number_previous_attacks_grid_12_months_all_encounter_types) average_number_previous_attacks_grid_12_months_all_encounter_types
  FROM
  ...
  SELECT
    ...
    average_attacks_by_route_on_date.average_number_previous_attacks_grid_12_months_all_encounter_types,
...
SELECT
  ...
  AVG(
  IF
    (days_since_average_attack_calculation <= 30*3,average_number_previous_attacks_grid_12_months_all_encounter_types,0)) average_route_attacks_last_3_months_all_encounter_types
FROM
  joined
GROUP BY
  trip_id