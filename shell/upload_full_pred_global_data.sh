#!/bin/bash
# Set path
export PROJECT_PATH="/Users/juancarlosvillasenorderbez/GitHub/piracy-shipping/"

# Upload all local csv files to GCS Bucket
gsutil cp "$PROJECT_PATH"processed_data/full_pred_global.csv gs://piracy-emlab-gcp
...
#bq rm -f -t emlab-gcp:piracy.full_pred_global_v_20240404
