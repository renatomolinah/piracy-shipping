...
Before attacking, the pirate compares the prize against the probability of being captured, $p$, and the associated fine, $p$. It follows that the pirate attacks whenever $b\geq ps$. Under this decision mechanism, the expected value of of a random encounter is then given by:
\begin{equation}
