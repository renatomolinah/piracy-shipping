...
# =============================================================================
# REGENERATE 3.2 MAIN ESTIMATION
# =============================================================================

cat("\nLoading 3.2 main estimation results...\n")
feature_coefficients <- readRDS(here("data", "output", "feature_coefficients.rds"))
...
cat("✓ Saved: all_features.png\n")

# =============================================================================
# REGENERATE 3.5 AVERAGE ATTACKS
# =============================================================================

cat("\nLoading 3.5 average attacks results...\n")
feature_coefficients <- readRDS(here("data", "output", "feature_coefficients_average.rds"))
...
cat("✓ Saved: all_features_average.png\n")

# =============================================================================
# REGENERATE 3.6 TOTAL ATTACKS
# =============================================================================

cat("\nLoading 3.6 total attacks results...\n")
feature_coefficients <- readRDS(here("data", "output", "feature_coefficients_total.rds"))
...
cat("✓ Saved: all_features_total.png\n")

# =============================================================================
# REGENERATE 3.7 SPEED AND DAYS CONTROLS
# =============================================================================

cat("\nLoading 3.7 speed and days controls results...\n")
feature_coefficients <- readRDS(here("data", "output", "feature_coefficients_speed_since.rds"))
