...
unescape_panel_labels(here(output_dir, "features.tex"))
...
unstyle_panel_headers(here(output_dir, "features.tex"))
append_fe_legend(here(output_dir, "features.tex"), has_bullet = TRUE)
...
append_fe_legend(here(output_dir, "spec_distance.tex"), has_bullet = FALSE)
...
append_fe_legend(here(output_dir, "spec_time.tex"), has_bullet = FALSE)
...
append_fe_legend(here(output_dir, "spec_speed.tex"), has_bullet = FALSE)
