# Main estimation controlling for vessel speed and days since last attack
...
# Distance and time only; speed and days_since_attack enter as additional controls
