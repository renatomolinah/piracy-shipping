# Compute 15-day prior attack counts for each voyage using country-to-country route matching
...
# --- Infer attacks from existing counts ---

cat("Inferring attacks from existing attack counts...\n")

# Detect attacks by looking at positive changes in cumulative counts between consecutive voyages
inferred_attacks <- dt[
  , .(
    trip_id,
    departure_date,
